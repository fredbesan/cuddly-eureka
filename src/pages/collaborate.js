...
const HeroBody = () => (
    <>
        <h1 className="title is-spaced big-title has-text-white	">Colabora</h1>
        <h2 className="subtitle is-4-desktop is-5-mobile">Descubre las mejores causas y únete como voluntario</h2>
    </>
)
